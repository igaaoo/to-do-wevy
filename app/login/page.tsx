  ...
  return (
    <div className="mt-20 flex w-full flex-col items-center justify-center">
      <Card className="w-[350px]">
        <CardHeader>
          <span className="mb-2 rounded bg-pink-700 py-0.5 text-center font-medium text-white">Realizar Login</span>
          <CardTitle className="text-center text-xl">To Do List - <span className="text-pink-700">Wevy</span></CardTitle>
          <CardDescription className="text-center">Preencha os campos para acessar o sistema</CardDescription>
        </CardHeader>
      ...
      <Link href="/register">
        <p className="mt-4 block text-center text-xs text-muted-foreground underline">Não é cadastrado? Clique aqui para se registrar</p>
      </Link>
    </div>
  );
}